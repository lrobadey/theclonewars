...
from schism_sim.engine.types import LocationId, Supplies
...
def load_game_state(path: Path) -> GameState:
    ...
    # Scenarios live in data/scenarios; rules live in sibling data/rules.
    rules_dir = path.parent.parent / "rules"
    state = GameState.new(seed=scenario.seed, data_dir=rules_dir)
